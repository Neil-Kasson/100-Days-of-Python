...
words = ['quotation', 'accompany', 'institution', 'distinct', 'linear', 
         'cucumber', 'agreement', 'contact', 'talented', 'contraction', 
         'dimension', 'clothes', 'distant', 'decrease', 'applied', 'shape', 
         'steam', 'expansion', 'intensify', 'final', 'memorial', 'spray', 
         'wriggle', 'equinox', 'muggy', 'attitude', 'tongue', 'provision', 
         'indication', 'relationship', 'serve', 'anniversary', 'balance', 
         'conception', 'poison', 'discipline', 'revival', 'initial', 'plain', 
         'resolution', 'cellar', 'publisher', 'drawer', 'disclose', 'century', 
         'throw', 'ticket', 'difficult', 'facility', 'proposal',
         ...
         'faking', 'fishhook', 'fixable', 'fjord', 'flapjack', 'flopping', 'fluffiness', 
         'flyby', 'foxglove', 'frazzled', 'frizzled', 'fuchsia', 'funny', 
         'gabby', 'galaxy', 'galvanize', 'gazebo', 'giaour', 'gizmo', 
         ...
         'kitsch', 'kiwifruit', 'klutz', 'knapsack', 
         ...
         'walkway', 'waltz', 'wave', 'wavy', 'waxy', 'wellspring', 'wheezy', 'whiskey', 
